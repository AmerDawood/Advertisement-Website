        ...
        <div class="col-lg-4 col-md-4">
            ...
            <div class="all-buutton2" style="height: 200px;">
                <div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editSectionModalLabel">تعديل السؤال</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form id="editSectionForm" action="{{ route('privacy.update', ['id' => $item->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                 ...
                 <form action="{{ route('privacy.destroy',['id'=>$item->id]) }}" method="POST">
                 @csrf
                 @method('DELETE')
