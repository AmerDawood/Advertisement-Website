    ...
    <div class="new-sec">
        ...
        <div style="text-align: center;">
            <div class="input-container" style="padding-top: 90px; display: inline-block;">
              <input type="text" class="form-control edit" placeholder="اكتب السؤال">
            </div>
            <div class="writsec" style="padding-top: 20px; display: inline-block;">
              <div class="input-container">
                <textarea class="form-control edit" rows="5" placeholder="  اكتب  الاجابة"></textarea>
              </div>
            </div>
           ...
           <div style="text-align: center">
            <div class="button-container" style="display: inline-block;">
                <a href="">
                  <button class="btn btn-success bt-sd" style="font-size: 20px;">نشر السؤال </button>
                </a>
              </div>
            </div>
