                    ...
                    <dic class="row">
                        <div class="card">
                            <div class="card-body" dir="rtl">
                                <h4 class="mt-3">ماهي تكلفة التثبيت؟ ماهي شروط تثبيت الإعلان؟                                </h4>
                                <p class="mt-5 mb-5">ال  تثبيت الإعلانات خدمة مجانية. شروط تثبيت الإعلان هي:
                                    يجب أن تحصل على 20 تقييم إيجابي خلال آخر سنه.
                                    يجب أن تكون السلعة تحتوي على صور و في القسم الصحيح.
                                    يجب أن تكون السلعة لنفس التاجر وليست لشخص آخر.عبئ</p>
                            </div>
                        </div>
                    </dic>
                </div>
            ...
            <div class="blog text-center pt-5 pb-5" id="blog ">
                <div class="container">
                    <dic class="row">
                        <div class="card">
                            <div class="card-body" dir="rtl">
                                <h4 class="mt-3">ميزة الرتبة
                                </h4>
                                <p class="mt-5 mb-5">
                                    تثبيت الإعلانات خدمة مجانية. شروط تثبيت الإعلان هي:
                                    يجب أن تحصل على 20 تقييم إيجابي خلال آخر سنه.
                                    يجب أن تكون السلعة تحتوي على صور و في القسم الصحيح.
                                    يجب أن تكون السلعة لنفس التاجر وليست لشخص آخر.
                                                            </div>
                        </div>
                    </dic>
                </div>
